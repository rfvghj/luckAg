<template>
  <div class="container">
    ...
    <div class="main_box">
      ...
      <div class="partner_box" ref="partner">
        <div class="dash_title">{{$t('part.v1')}}</div>
        <div class="row">
          <div class="col-md-6">
            <div class="partner_left_box">
              <div class="left_item_box">
                <img src="../../assets/image/pc/cat2.png" alt="">
                <div class="left_link_box">
                  <div>{{$t('part.v2_1')}}</div>
                  <div>{{url}}</div>
                  <div class="copy_btn btn_common">{{$t('part.v2_2')}}</div>
                </div>
              </div>
              <div class="enjoy_box">{{$t('part.v3')}}</div>
              <div class="per_info_box">{{$t('part.v4')}}</div>
              <img class="sheep_img" src="../../assets/image/pc/sheep.png" alt="">
            </div>
          </div>
          <div class="col-md-6">
            <div class="partner_right_box">
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount}}</div>
                <div>{{$t('part.v5')}}</div>
              </div>
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount1}}</div>
                <div>{{$t('part.v6')}}</div>
              </div>
            </div>
            <div class="partner_right_box">
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount2}}</div>
                <div>{{$t('part.v7')}}</div>
              </div>
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount3}}</div>
                <div>{{$t('part.v8')}}</div>
              </div>
            </div>
            <div class="partner_right_box">
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount4}}</div>
                <div>{{$t('part.v9')}}</div>
              </div>
              <div class="partner_item_box">
                <div class="par_price_box">{{UserAmount5}}</div>
                <div>{{$t('part.v10')}}</div>
              </div>
            </div>
          </div>
...
import { BigNumber, Contract, ethers, Wallet, providers, utils } from 'ethers';
  ...
  async  mounted() {
   ...
   watch:{
    ...
    var contracts = {};
    contracts["ido"] = new Contract(tokens[2].LuckIdoAdr, idoAbi, provider);
    var amountU = await contracts["ido"].idoUserAmount();
    this.UserAmount = amountU.toString();
    if(privateAddress){
      ...
      this.UserAmount1 = list1[0].toString();
      this.UserAmount2 = list1[1].toString();
      this.UserAmount3 = list1[2].toString();
      this.UserAmount4 = list1[3].toString();
      this.UserAmount5 = list1[4].toString();
     var bools =  await contracts["ido"].tokenBalanceBool(privateAddress);
     if(bools){
      this.url = this.$store.state.yourLink;
     }
      }
    }
    }
